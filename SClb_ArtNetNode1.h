...
#ifndef SClb_ArtNetNode1_H
#define SClb_ArtNetNode1_H
...
class SCArtNet1 : public SClb_Arduino_DMXEthernet {
...
public:
	...
	*/
	SCArtNet1(IPAddress address, IPAddress subnet_mask, uint8_t* buffer);


	/*!
	* @brief destructor for SCArtNet1 (frees packet buffer if allocated with constructor)
	*/
	~SCArtNet1(void);
...
#endif // ifndef SClb_ArtNetNode1_H
